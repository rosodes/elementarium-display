...
const uiFr = {
  ...
  // еlements французские – временно английские
  // ... позже заменить на fr элементы
  elements: {},
};
...
const elementDetailsFr = {
  ...
  electronShellVisualization: "Visualisation de la couche électronique",
  ...
  azimuthal: "Azimutal",
  magnetic: "Magnétique",
  orbitalDiagram: "Diagramme orbitalaire",
  ...
  noToxicityInfo: "Pas d’informations sur la toxicité.",
  ecologyInfo: "Écologie",
  ecologicalImpact: "Impact écologique",
  reactivity: "Réactivité",
  noEcologyInfo: "Pas d’informations sur l’écologie.",
