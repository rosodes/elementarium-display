...
export const elementDetailsRu: ElementDetailsTranslations = {
  ...
  noEcologyInfo: "Нет значительной экологической информации или информации о реактивности на данный момент.",
  noOxidationStatesForNobleGases: "Благородные газы не имеют степеней окисления в обычных условиях.",
  noOxidationStates: "Нет доступных данных о степенях окисления.",
  ...
  knownSinceAncient: "Известен с древности",
