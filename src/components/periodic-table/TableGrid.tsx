...
const TableGrid = memo(({ onElementClick }: TableGridProps) => {
  ...
  // Элементы с их точными позициями в сетке
  const elementPositions = [
    ...
    // Период 6 - с лантаноидным пропуском
    { atomic: 55, row: 7, col: 2 },  { atomic: 56, row: 7, col: 3 },
    { atomic: 57, row: 7, col: 4 },  // La (заполнитель для лантаноидов)
    ...
    // Период 7 - с актиноидным пропуском
    { atomic: 87, row: 8, col: 2 },  { atomic: 88, row: 8, col: 3 },
    { atomic: 89, row: 8, col: 4 },  // Ac (заполнитель для актиноидов)
