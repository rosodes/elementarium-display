...
export const elements: ElementsArray = [
  ...
  // Phosphorus (15) - Complete the element properly
  {
    atomic: "15",
    symbol: "P",
    name: "Phosphorus",
    ...
    description: "Phosphorus is a nonmetal that exists in several forms. It is highly reactive and is never found as a free element in nature."
  },
  ...
  // Sulfur (16)
  {
    ...
    atomicMass: "32.06",
    electronConfiguration: "1s² 2s² 2p⁶ 3s² 3p⁴",
    description: "Sulfur is a bright yellow, crystalline solid at room temperature. It is an essential element for all life and is widely used in industrial processes."
  },
  ...
  // Chlorine (17)
  {
    ...
    atomicMass: "35.45",
    electronConfiguration: "1s² 2s² 2p⁶ 3s² 3p⁵",
    description: "Chlorine is a yellow-green gas with a pungent smell. It is a highly efficient disinfectant and is used in the production of many industrial and consumer products."
  },
  ...
  // Calcium (20)
  {
    ...
    name: "Calcium",
    weight: "40.078",
    electronstring: "1s2 2s2 2p6 3s2 3p6 4s2",
    series: "Alkaline",
    melt: "1115",
    boil: "1757",
    electroneg: "1.00",
